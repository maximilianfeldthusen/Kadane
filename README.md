...
Here’s your text converted into clean **GitHub-flavored Markdown** with proper formatting, headings, code blocks, and lists:
...
Would you like me to also add a **visual diagram** (flowchart-style) of Kadane’s Algorithm to make the explanation even clearer?
